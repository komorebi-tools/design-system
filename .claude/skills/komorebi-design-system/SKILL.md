...
```css
h1, h2, h3 {
  font-weight: 700;  /* 太字は必須。省略すると見出しが細くなり視認性が落ちる */
  font-feature-settings: "palt" 1, "kern" 1;  /* 日本語プロポーショナルメトリクス */
  letter-spacing: 0.05em;  /* 見出し・本文共通 */
}
...
```css
body {
  line-height: 1.6;       /* 以前は 1.5 だったが更新済み */
  letter-spacing: 0.05em; /* 以前は 0 だったが更新済み */
}
```
